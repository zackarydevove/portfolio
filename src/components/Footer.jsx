...
function Footer() {
  return (
    <div className='w-screen h-[10vh] px-5 flex justify-center items-center bg-dark_grey dark:bg-[#1b1b1b] text-white'>
        <div className='flex w-[900px] h-full justify-between items-center'>
            ...
            <div className='flex'>
                <div className='flex gap-3'>
                  <a href={new URL('http://linkedin.com/in/zackarydevove/')} target='_blank' rel="noreferrer">
                    <AiFillLinkedin size='2em' className='hover:cursor-pointer hover:text-blue transition duration-300' /> 
                  </a>
                  <a href={new URL('https://twitter.com/ZackaryDevove')} target='_blank' rel="noreferrer">
                    <AiFillTwitterCircle size='2em' className='hover:cursor-pointer hover:text-blue transition duration-300'/>
                  </a>
                  <a href={new URL('https://github.com/zackarydevove')} target='_blank' rel="noreferrer">
