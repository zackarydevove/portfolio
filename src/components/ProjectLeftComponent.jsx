...
function ProjectLeftComponent({ title, content,  githubLink, demoLink, tech, img }) {
	return (
		<div className='p-3'>
			{/* Row */}
			<div className='max-sm:pt-2 max-lg:pt-5 lg:w-[990px] lg:h-[400px] h-auto max-[390px]:h-[850px] max-[240px]:h-[890px] w-[570px] max-lg:min-h-[750px] max-w-[98vw] bg-white dark:text-white dark:bg-[#131313] dark:border dark:border-[#1b1b1b] shadow-[0px_0px_10px_0px_rgba(0,0,0,0.3)] rounded-2xl flex max-lg:flex-col justify-evenly items-center'>
				{/* Image */}
				<a 
					href={ demoLink ? demoLink : githubLink} target="_blank" rel="noreferrer" 
					className={`lg:w-[47%] lg:h-[90%] sm:w-[530px] h-[400px] max-sm:h-[50vh] w-[95%] ${img} bg-cover  shadow-[0px_0px_10px_0px_rgba(0,0,0,0.3)] rounded-2xl lg:hover:scale-105 transition`}
				/>
				{/* Text */}
...
export default ProjectLeftComponent
